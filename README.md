About cuda-sanitizer-api-feedstock
==================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cuda-sanitizer-api-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cuda-sanitizer-api-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cuda-sanitizer-api
# for installing globally
pixi global install cuda-sanitizer-api
```
...
It is possible to list all of the versions of `cuda-sanitizer-api` available on your platform:
...
```
pixi search cuda-sanitizer-api --channel conda-forge
```
